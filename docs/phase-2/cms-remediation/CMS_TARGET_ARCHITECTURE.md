...
| Measure | Value |
|---|---:|
| Pages where decompose → render is byte-identical | **40 / 40** |
| Total blocks produced | 1,854 |
| Top-level sections (movable, removable, duplicable) | 176 |
| **Individually editable content slots** | **4,956** |
| **Repeatable collections (add / duplicate / reorder items)** | **147** |
