...
export const navigationGroups = [
  {
    ...
    items: [
      ...
      { label: "Custody & Vault Structure", href: "/custody-vault-structure" },
      { label: "Independent Verification", href: "/independent-verification" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Independent Verification", href: "/independent-verification" },
      { label: "Custody & Vaults", href: "/custody-vault-structure" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Independent Verification", href: "/independent-verification" },
      { label: "Custody & Vault Structure", href: "/custody-vault-structure" },
      { label: "Proof of Gemstone Reserves", href: "/proof-of-reserves" },
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Early Participation Program",
        href: "/early-participation-program",
      },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Anti-Fraud Notice", href: "/anti-fraud-notice" },
